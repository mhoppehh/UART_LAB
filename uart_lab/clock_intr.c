...
#define TIMER4A_PRESCALER 50 // TODO - Edit this so a 16-bit timer will not overflow in 1 second
#define TIMER4B_PRESCALER 10 // TODO - Edit this so a 16-bit timer will not overflow in 200 ms
